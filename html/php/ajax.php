...
switch ($_REQUEST['action']) {
	case 'Tab_1_name':
		echo "<?php
					include '/html/php/model-page-table/uaz-patriot-complectation-and-price.php'
					?>
					...
					<div class='model-page__exterior-block model-page__content-block'>
						...
						<div class='bxslider'>						
							<?php
							include '/html/php/model-page-photoes/uaz-patriot-exterior.php'
							?>
						</div>
					...
					<div class='model-page__interion-block model-page__content-block'>
						...
						<ul class='bxslider'>						
							<?php
							include '/html/php/model-page-photoes/uaz-patriot-interior.php'
							?>
						</ul>
						...
						<label for='paragraph__checkbox--2' class='paragraph__label-show-more paragraph__label--2'>Показать больше</label>
							...
							<div class='model-page__tech-specification'>
								...
								<hr class='headline'>
								<?php
								include '/html/php/model-page-table/uaz-patriot-tech-spec.php'
								?>
							</div>
							...
							<div class='model-page__in-stock'>
								...
								<hr class='headline'>
								<?php
								include '/html/php/model-page-table/uaz-patriot-in-stock.php'
								?>
							</div>
";
		break;
...
";
	...
	case 'Tab_5_name':
		echo "<h2>Стандартные пакеты тюнинга УАЗ</h2>
							<hr class='headline'>

							<ul class='bxslider'>						
								<?php
								include '/html/php/tuning/uaz/standart-options.php'
								?>
							</ul>
							...
							<ul class='bxslider'>						
								<?php
								include '/html/php/tuning/uaz/individual-options.php'
								?>
							</ul>
	...
	case 'Tab_6_name':
		echo "   <div class='model-page__tech-specification'>
								<h2>Технические характеристики</h2>
								<hr class='headline'>
								<?php
								include '/html/php/model-page-table/uaz-patriot-tech-spec.php'
	...
	case 'Tab_7_name':
		echo "<div class='model-page__exterior-block model-page__content-block'>
								<h2>Экстерьер</h2>
								<hr class='headline'>
								<ul class='bxslider'>						
									<?php
