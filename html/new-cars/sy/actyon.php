	...
	<main>
		...
		<div class="container">
			<div class="content-block-with-nav model-page container clearfix">
				<section class="main-column">
					...
					<div class="model-page__photo-block clearfix">
						<div class="model-photoes">
							<img src="/img/cars/sy/actyon/1.png" alt="" class="active red">		
							<img src="/img/cars/sy/actyon/2.png" alt="" class=" grey">		
							<img src="/img/cars/sy/actyon/3.png" alt="" class=" light-grey">		
							<img src="/img/cars/sy/actyon/4.png" alt="" class=" ligth-light-grey">		
							<img src="/img/cars/sy/actyon/5.png" alt="" class=" white">		
							<img src="/img/cars/sy/actyon/6.png" alt="" class=" blue">		
							<img src="/img/cars/sy/actyon/7.png" alt="" class=" black">							
						</div>
						<div class="model-page__color-pick-block">
							<div data-color="red" class="color-pick color-pick--red active"></div>
							<div data-color="grey" class="color-pick color-pick--grey"></div>
							<div data-color="light-grey" class="color-pick color-pick--light-grey"></div>
							<div data-color="ligth-light-grey" class="color-pick color-pick--ligth-light-grey"></div>
							<div data-color="white" class="color-pick color-pick--white"></div>
							<div data-color="blue" class="color-pick color-pick--blue"></div>
							<div data-color="black" class="color-pick color-pick--black"></div>
						</div>
					</div>
					<div class="model-page__form-block form-block">
						<form action="" class="clearfix sy">
							<div class="price-description">
								<span class="wanna-buy">Хотите приобрести SsangYong Actyon?</span>
								<div class="price-block">
									<span class="price">Цена от <span>999 000</span> руб.</span>
				...
				<div class="nav-column nav-column-sy clearfix">
					<?php
		...
		<div class="container">
	      ...
	      <div class="ionTabs__item" data-name="Tab_1_name">
					<?php
					include $_SERVER['DOCUMENT_ROOT'].'/html/php/model-page-table/sy-actyon-complectation-and-price.php'
					?>
					...
					<div class="model-page__exterior-block model-page__content-block">
						...
						<div class="bxslider">						
							<?php
							include $_SERVER['DOCUMENT_ROOT'].'/html/php/model-page-photoes/sy-actyon-exterior.php'
							?>
						</div>
					...
					<div class="model-page__interion-block model-page__content-block">
						...
						<ul class="bxslider">						
							<?php
							include $_SERVER['DOCUMENT_ROOT'].'/html/php/model-page-photoes/sy-actyon-interior.php'
							?>
						</ul>
						...
						<label for="paragraph__checkbox--2" class="paragraph__label-show-more paragraph__label--2">Показать больше</label>
							...
							<div class="model-page__tech-specification">
								...
								<hr class="headline">
								<?php
								include $_SERVER['DOCUMENT_ROOT'].'/html/php/model-page-table/sy-actyon-tech-spec.php'
								?>
							</div>
							...
							<div class="model-page__in-stock model-page__in-stock--collapsed">
								...
								<hr class="headline">
								<?php
								include $_SERVER['DOCUMENT_ROOT'].'/html/php/model-page-table/sy-actyon-in-stock.php'
								?>
							</div>
		        ...
		        <div class="ionTabs__item" data-name="Tab_2_name">
		           ...
		           <div class="model-page__in-stock">
								<h2>SsangYong Actyon в наличии</h2>
								<hr class="headline">
								<?php
								include $_SERVER['DOCUMENT_ROOT'].'/html/php/model-page-table/sy-actyon-in-stock.php'
								?>
			...
			<div class="model-page__tuning-block">
				...
				<ul class="tablet-visible-block bxslider-tablet clearfix">
					...
					include $_SERVER['DOCUMENT_ROOT'].'/html/php/model-page/uaz/tuning.php'
					?>
				<a href="" class="link-view-all">Все для тюнинга SsangYong</a>
				</ul>
			</div>
			<div class="model-page__where-to-buy">
					<h2>Где купить SsangYong Actyon</h2>
					<hr class="headline">
					<?php
			...
			<div class="model-page__similar-auto">
				<h2>Похожие на SsangYong Actyon автомобили</h2>
				<hr class="headline">
				<?php
